...
use {
    container_chain_template_move_runtime::{
...
pub fn development_config(para_id: ParaId, boot_nodes: Vec<String>) -> ChainSpec {
    ...
    ChainSpec::builder(
        container_chain_template_move_runtime::WASM_BINARY
...
pub fn local_testnet_config(para_id: ParaId, boot_nodes: Vec<String>) -> ChainSpec {
    ...
    .with_name(&format!("Move Container {}", para_id))
    .with_id(&format!("move_container_{}", para_id))
...
fn testnet_genesis(
    ...
    let g = container_chain_template_move_runtime::RuntimeGenesisConfig {
        balances: container_chain_template_move_runtime::BalancesConfig {
        ...
        parachain_info: container_chain_template_move_runtime::ParachainInfoConfig {
            parachain_id: id,
            ..Default::default()
        },
        parachain_system: Default::default(),
        sudo: container_chain_template_move_runtime::SudoConfig {
            key: Some(root_key),
        },
        authorities_noting: container_chain_template_move_runtime::AuthoritiesNotingConfig {
        ...
        move_module: container_chain_template_move_runtime::MoveModuleConfig {
            change_default_move_stdlib_bundle_to: Option::<Vec<u8>>::None,
            change_default_substrate_stdlib_bundle_to: Option::<Vec<u8>>::None,
